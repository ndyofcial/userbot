...
async def _(client, message):
    ...
    if status and hasattr(status, "text"):
        ...
        # ✅ Cek kondisi aman (tidak dibatasi)
...
"""
        # ❌ Cek kondisi limit
        elif "dibatasi" in teks_spambot or "restricted" in teks_spambot or "limit" in teks_spambot:
            text = f"""
...
"""
            ...
            text = f"""
<b>⌭ {pong} Status Akun : ⚠ Tidak Diketahui</b>
❓ Tidak dapat menentukan status akun anda.
Berikut pesan dari SpamBot:
...
"""
        ...
        await message.reply("❌ Tidak bisa membaca status dari SpamBot.")
